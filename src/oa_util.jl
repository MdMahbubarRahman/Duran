...
"""
function init_oa_data(op::OriginalProblem, oa_data::OAdata)
    oa_data.num_var = op.num_var
    oa_data.var_type = op.var_type

    oa_data.num_constr = op.num_constr
    oa_data.num_nl_constr = op.num_nl_constr
    oa_data.num_l_constr = op.num_nl_constr
...
function construct_nlp_model(model::MOI.AbstractOptimizer, op::OriginalProblem, oa_data::OAdata)
    this function generates a nlp_model from the original model provided as OriginalProblem.
"""
function reformulated_nlp_model(model::MOI.AbstractOptimizer, op::OriginalProblem, oa_data::OAdata)
